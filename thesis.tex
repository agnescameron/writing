...
\begin{marginfigure}
\includegraphics[width=\textwidth]{img/3/perlman-material.jpg}
...
What does it mean to take part in a civic system? In this section, I explore theories of participation, with a focus on the use of games and play as a means of making legible otherwise dull, inaccessible or obscure processes. While here I foucus on ideas within the field of urbanism, these ideas may also be applied to forms of political participation.
...
\begin{marginfigure}
\includegraphics[width=\textwidth]{img/2/divertsy.png}
...
%IMAGE TO ADD: zwdg
\begin{marginfigure}
\includegraphics[width=\textwidth]{img/2/zero-waste-guidelines.png}
...
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{img/4/loopy/small-static.png}
\caption{\textit{Initial system, static}}
\end{subfigure}
 \quad
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{img/4/loopy/small-win.png}
...
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{img/4/loopy/small-lose.png}
...
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{img/4/loopy/big-static.png}
\caption{\textit{Initial system, static}}
\end{subfigure}
 \quad
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{img/4/loopy/big-win.png}
\caption{\textit{Winning the game}}
  \label{small:win}
\end{subfigure}%
\quad
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{img/4/loopy/big-lose.png}
  \caption{\textit{Losing the game}}
  \label{small:lose}
\end{subfigure}% 
\end{figure*}
...
This study was conducted in the Media Lab, with the Object Based Media Group. 
...
Describe: layout of space, layout of bins
