...
% Through this thesis, I broadly take the approach outlined by Schamin\'ee in \emph{Designing With(in) Public Organisations}
...
Urban designer Usman Haque emphasises the importance of local decision-making when it comes to creating cultural interventions, asserting that ???? such that ???? \cite{haque_citizen_2017}. 
...
In \emph{Postmodernism}, Frederic Jameson reflects on what Lynch's cognitive mapping might look like ??? 'for an era which has ...' ???. He calls for  \cite{jameson_postmodernism_1991}.  
...
As Lobo puts it:``Forgetting the irony and playfulness of SimCity in the classroom would equal to teaching civic behavior with fighting games such as Mortal Kombat, Quake or Tekken IV''. Critiques the fact that the player's power is never called into question, only lose may
