...
This thesis incorporates a study that uses mixed methods to observe links between attitude and behaviour in relationship to waste, and observes limitations in the efficacy of these games to change a relationship with a system that is necessarily grounded in habit, and does not otherwise change in relation to the subject. This result is one discussed by a number of scholars of environmental psychology, but it nonetheless contradicts a popular belief: that awareness of a problem is sufficient to shape forces of habit.


\section*{Future Work}
Further studies will be needed to see whether the change in attitude fostered by participation in these games is significant in the context of infrastructural change. In addition, it would be interesting to see whether such games could contribute to the legibility of other such complex information systems.
